    ...
    return (
        <nav className="bg-white dark:bg-neutral-900/50 backdrop-blur-md fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="items-center justify-center w-full flex md:w-auto">
                {isLogin?
                    <ul className="flex p-4 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-12 rtl:space-x-reverse md:mt-0 md:border-0">
                    <li>
                        <NavLink 
                            to="/" 
                            className={({ isActive }) => 
